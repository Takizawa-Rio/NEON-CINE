...
interface CinemaDao {
    ...
    @Query("DELETE FROM tickets WHERE id = :ticketId OR (barcode != '' AND barcode = :barcode) OR (bookingCode != '' AND bookingCode = :bookingCode)")
    suspend fun deleteTicketByAny(ticketId: Int, barcode: String, bookingCode: String)
